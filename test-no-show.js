...
async function testNoShow() {
  try {
    ...
    console.log('1. Creating new checkout session...');
    ...
    console.log('4. Use that payment intent ID to test the no-show scenario');
    console.log('\n5. Once you have the payment intent ID, run this command:');
    console.log('   curl -X POST http://localhost:3001/api/handle-no-show \\');
    console.log('   -H "Content-Type: application/json" \\');
    console.log('   -d \'{"paymentIntentId": "YOUR_PAYMENT_INTENT_ID", "noShowFeePercentage": 50}\'');
